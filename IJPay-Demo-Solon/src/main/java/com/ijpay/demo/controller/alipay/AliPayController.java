...
//            model.setExtendParams(extendParams);
	...
	@Mapping("/tradePay")
	public String tradePay(@Param("authCode") String authCode, @Param("scene") String scene) {
		String subject = null;
...
//        String notifyUrl = aliPayBean.getDomain() + NOTIFY_URL;
	...
	@Mapping("/transferQuery")
	public String transferQuery(@Param(required = false, name = "outBizNo") String outBizNo,
								@Param(required = false, name = "orderId") String orderId) {
	...
	@Mapping("/uniTransferQuery")
	public String uniTransferQuery(@Param(required = false, name = "outBizNo") String outBizNo,
								   @Param(required = false, name = "orderId") String orderId) {
	...
	@Mapping("/accountQuery")
	public String accountQuery(@Param(required = true, name = "aliPayUserId") String aliPayUserId) {
	 ...
	 * 资金授权冻结接口
	 */
	@Mapping("/authOrderFreeze")
	public AlipayFundAuthOrderFreezeResponse authOrderFreeze(@Param("auth_code") String authCode) {
		try {
	 ...
	 * 下载对账单
	 */
	@Mapping("/dataDataServiceBill")
	public String dataDataServiceBill(@Param("billDate") String billDate) {
		try {
	 ...
	 */
	@Mapping("/tradeRefund")
	public String tradeRefund(@Param(required = false, name = "outTradeNo") String outTradeNo, @Param(required = false, name = "tradeNo") String tradeNo) {
	 ...
	 */
	@Mapping("/tradeQuery")
	public String tradeQuery(@Param(required = false, name = "outTradeNo") String outTradeNo, @Param(required = false, name = "tradeNo") String tradeNo) {
		try {
	...
	@Mapping("/tradeQueryByStr")
	public String tradeQueryByStr(@Param(required = false, name = "outTradeNo") String outTradeNo, @Param(required = false, name = "tradeNo") String tradeNo) {
		AlipayTradeQueryModel model = new AlipayTradeQueryModel();
		if (StringUtils.isNotEmpty(outTradeNo)) {
			model.setOutTradeNo(outTradeNo);
		}
	 ...
	 */
	@Mapping("/tradeCreate")
	public String tradeCreate(@Param("outTradeNo") String outTradeNo) {
	 ...
	 */
	@Mapping("/tradeCancel")
	public String tradeCancel(@Param(required = false, name = "outTradeNo") String outTradeNo, @Param(required = false, name = "tradeNo") String tradeNo) {
		try {
	 ...
	 */
	@Mapping("/tradeClose")
	public String tradeClose(@Param("outTradeNo") String outTradeNo, @Param("tradeNo") String tradeNo) {
		try {
	 ...
	 * 结算
	 */
	@Mapping("/tradeOrderSettle")
	public String tradeOrderSettle(@Param("tradeNo") String tradeNo) {
		try {
	 ...
	 * 应用授权回调
	 */
	@Mapping("/redirect_uri")
	public String redirectUri(@Param("app_id") String appId, @Param("app_auth_code") String appAuthCode) {
		try {
	 ...
	 * 查询授权信息
	 */
	@Mapping("/openAuthTokenAppQuery")
	public String openAuthTokenAppQuery(@Param("appAuthToken") String appAuthToken) {
		try {
	 ...
	 * 地铁购票核销码发码
	 */
	@Mapping("/voucherGenerate")
	public String voucherGenerate(@Param("tradeNo") String tradeNo) {
		try {
			//需要支付成功的订单号
