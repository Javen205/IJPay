...
<body ontouchstart>
	<div class="weui-tab">
		<div class="weui-tab__bd">
			<div id="tab0" class="weui-tab__bd-item weui-tab__bd-item--active">
				...
				<div class="bd">
					...
					<div class="weui-btn-area">
						<a href="javascript:scanCode1();" class="weui-btn weui-btn_primary">确定支付</a>
					</div>
			...
			<div id="tab1" class="weui-tab__bd-item">
				...
				<div class="bd">
					...
					<div class="weui-btn-area">
						<a href="javascript:scanCode2();" class="weui-btn weui-btn_primary">确定支付</a>
					</div>
					<div class="weui-btn-area">
						<a  href="<%=path %>/toOauth?state=wxpay" class="weui-btn weui-btn_warn">重新获取openId</a>
					</div>
					<div style="text-align: center; margin-top: 30px">
		...
		<div class="weui-tabbar">
			...
			<a href="#tab1" class="weui-tabbar__item"> <!-- <span
				class="weui-badge"
