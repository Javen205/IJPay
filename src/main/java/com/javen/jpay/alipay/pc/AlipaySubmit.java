...
public class AlipaySubmit {
     ...
     * @return 提交表单HTML文本
     */
    public static String buildRequest(Map<String, String> sParaTemp, String strMethod, String strButtonName, String sign_type, String private_key, String input_charset) {
        //待请求参数数组
